      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerText}>
            <Title style={styles.greeting}>Investment Accounts</Title>
            <Paragraph style={styles.subGreeting}>Manage and optimize your investments</Paragraph>
          </View>
        </View>

        <Title style={styles.sectionTitle}>Investment Tools</Title>
